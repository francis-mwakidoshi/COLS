...
$query=mysql_query("SELECT *FROM staff WHERE staffno='$staffno'")or die(mysql_error());
$query_arr=mysql_fetch_array($query);
$deptid=$query_arr['departmentId'];
if($depid=1){
$po=mysql_query("SELECT telno FROM hod WHERE deptID='1'");
$arr3=mysql_fetch_array($po);
$phone=$arr3['telno'];

}
if($depid=2){
$po=mysql_query("SELECT telno FROM hod WHERE deptID='2'");
$arr3=mysql_fetch_array($po);
$phone=$arr3['telno'];

}
if($depid=3){
$po=mysql_query("SELECT telno FROM hod WHERE deptID='3'");
$arr3=mysql_fetch_array($po);
$phone=$arr3['telno'];

}
if($depid=4){
$po=mysql_query("SELECT telno FROM hod WHERE deptID='4'");
$arr3=mysql_fetch_array($po);
$phone=$arr3['telno'];
...
$message = "Hi.I have applied for leave.The staff number is: ".$staffno.". Thank you.";
