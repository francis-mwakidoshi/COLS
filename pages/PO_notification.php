...
$status=$_GET['status'];
$query=mysql_query("SELECT *FROM staff WHERE Id='$status'")or die(mysql_error());
$query_arr=mysql_fetch_array($query);
$staffno=$query_arr['staffno'];

$po=mysql_query("SELECT telno FROM personelofficer");
$arr3=mysql_fetch_array($po);
$phone=$arr3['telno'];
// Specify your login credentials
$username    = "maglado";
$apiKey      = "8c79b94e5c9633ca052ce3b86a60234c9842ae81bdc217666a9bede1245888f6"; 
...
$message = "Hi.This is a notification from the HOD office.The application for leave by the employee with the No:".$staffno." has been looked at.";
