...
$status_check=mysql_query("SELECT * FROM leavestatus WHERE leaveId='$lid'");
...
<div id="templatemo_main">
	...
	$leaveid=$result['Id'];
		...
		$insertS="INSERT INTO leavestatus(staffID,HODApproval,leaveId) VALUES('$id','$approvalstatus','$leaveid')";
		mysql_query($insertS);
			$decline="declined";
