...
$query="SELECT staff.*, (SELECT COUNT(*) FROM leavedetails WHERE staffID=staff.Id) AS count FROM staff";
...
<td><a href="POapproval.php?no=<?php echo $row['Id']."& app= ".$row['count'];?>">Check</a></td>
</tr>
<?php endwhile;?>
</table>
    </div>
