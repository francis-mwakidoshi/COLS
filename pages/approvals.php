...
$status=mysql_query("SELECT*FROM leavestatus WHERE HODApproval='approved'");
$arr=mysql_fetch_array($status);

$agent=mysql_query("SELECT *FROM staff WHERE Id='{$arr['staffID']}'");
...
<div id="templatemo_main">
 ...
 <div id="content">
 <a href="Mstaff.php"><button style="margin-left:-100px;">Back</button></a>
 <table>
 <tr>
<a href="messageProfile.php"><button>Sms Notifications</button></a>
	</tr><br><br>
	<tr><a href="POleave_View.php"><button>Applications Approvals</button></a></tr></table>
    </div>
